          ...
          <div key={index}>
            <div className='flex flex-col md:flex-row md:items-center md:justify-between md:gap-3'>
              <a
                target='_blank'
                href={story.url}
                className='text-lime-500 visited:font-medium visited:text-pink-500 hover:text-lime-400'
              >
                {story.title}
              </a>
            ...
            <div className='flex items-center justify-between text-sm'>
              <span className='text-neutral-500'>
                ...
                <Link
                  to={`/user/${story.by}`}
                  className='self-end text-neutral-400 hover:underline'
                >
                  {story.by}
                </Link>
...
export const Loading = () => {
  return (
    <div className='flex items-center justify-center gap-3 py-4 text-neutral-400'>
      <svg
        className='h-5 w-5 animate-spin text-lime-600'
